package com.giuseppe_longhitano.features.coins.coin_details.view
...
import com.giuseppe_longhitano.features.coins.coin_details.CoinDetailsEvent
            ...
            CoinLineChart(
                ...
                handleEvent = {
                   val event = when(it){
                        ...
                        is ChartEvent.OnDaysChange-> CoinDetailsEvent.OnIntervalChange(HourInterval.safeValueOf(it.dayInterval))
                        else -> it
                    }
